                ...
                _this.authService.registerUser(user_1).subscribe(function (data) {
                    if (data.success) {
                        ...
                        _this.smsService.sendSMS(smsDetails).subscribe(function (response) {
                            if (response.success) {
                                _this.toasterService.pop('success', 'Success', 'An SMS has been sent to student\'s phone');
                            }
                            else {
                                _this.toasterService.pop('error', 'Oops!', response.msg);
                            }
...
var AspirantsComponent = (function () {
    ...
    AspirantsComponent.prototype.getAspirants = function () {
        ...
        this.aspirateService.getAspirants().subscribe(function (data) {
            if (data.success) {
                ...
                _this.aspirants.forEach(function (element) {
    ...
    AspirantsComponent.prototype.removeAspirant = function (matricNo) {
        var _this = this;
        var pageDimmer = '<div class="ui inverted page dimmer active" id="pageDimmer"><div class="content"><div class="center"><div class="center"><div class="ui indeterminate large text loader"><h3>Please wait...</h3></div></div></div></div></div>';
        __WEBPACK_IMPORTED_MODULE_5_jquery__('body').prepend(pageDimmer);
        this.aspirateService.deleteAspirant(matricNo).subscribe(function (data) {
            if (data.success) {
                _this.toasterService.pop('success', 'Success!', data.message);
            }
            else {
                _this.toasterService.pop('info', 'Oops!', 'Aspirant could not be deleted at the moment.');
            }
            _this.ngOnInit();
        }, function (err) {
            _this.toasterService.pop('error', 'Oops!', err);
...
module.exports = "<div class=\"introduction\">\n    <h1 class=\"ui inverted header\">\n        <span class=\"bigheader\">\n            E-Voting System\n        </span>\n        <br /><br />\n        <span class=\"tagline\">\n            Electoral transparency, accountability, security and accuracy.\n        </span>\n    </h1>\n    <div class=\"ui hidden divider\"></div>\n    <a *ngIf=\"!authService.loggedIn()\" [routerLink]=\"['/register']\" class=\"ui huge primary button\"><i class=\"icon credit card\"></i>Click here to Buy Form</a>\n    <a *ngIf=\"!authService.loggedIn()\" [routerLink]=\"['/login']\" class=\"ui huge inverted basic button\"><i class=\"icon sign in\"></i>Login</a>\n    <a *ngIf=\"authService.loggedIn()\" [routerLink]=\"['/dashboard']\" class=\"ui huge inverted basic button\"><i class=\"icon dashboard\"></i>Dashboard</a>\n    <div class=\"ui divider\"></div>\n    <div class=\"ui hidden divider\"></div>\n    <div class=\"ui hidden divider\"></div>\n    <h3 class=\"ui inverted header\">\n        <span class=\"bigheader\">\n            Aspirant's Data Form\n        </span>\n    </h3>\n    <div *ngIf=\"!authService.loggedIn()\" class=\"ui left icon fluid action huge input\">\n        <i class=\"id badge icon\"></i>\n        <input type=\"text\" placeholder=\"Please enter your payment reference number here and click proceed ->\" (keypress)=\"triggerProceed($event)\" [(ngModel)]=\"payment_ref\" maxlength=\"13\" name=\"payment_ref\" id=\"payment_ref\">\n        <button type=\"button\" class=\"ui primary right labeled icon button\" (click)=\"proceed()\" id=\"proceedBtn\">\n            <i class=\"arrow right icon\"></i>\n            Proceed\n        </button>\n    </div>\n</div>\n<div class=\"ui divider\"></div>\n<div class=\"ui container\">\n    <div class=\"ui stackable grid\">\n        <div class=\"sixteen wide column\">\n            <div class=\"ui horizontal segments\">\n                <div class=\"ui padded segment\">\n                    <p><img src=\"assets/images/1.jpeg\" class=\"ui fluid image\" /></p>\n                </div>\n                <div class=\"ui padded segment\">\n                    <p><img src=\"assets/images/2.jpeg\" class=\"ui fluid image\" /></p>\n                </div>\n                <div class=\"ui padded segment\">\n                    <p><img src=\"assets/images/3.jpeg\" class=\"ui fluid image\" /></p>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>\n"
...
var RegisterComponent = (function () {
            ...
            if (response.isElcom) {
                ...
                _this.studentService.getStudentRecord(matricno).subscribe(function (response) {
                    if (!response.success) {
                        ...
                        _this.matricno = __WEBPACK_IMPORTED_MODULE_8_jquery__('#matricno').val();
                        var fullName = response.student_info.full_name;
                        var nameArray = fullName.split(' ');
                        var lastname = nameArray[0];
                        var firstname = nameArray[1];
                        ...
                        var email = __WEBPACK_IMPORTED_MODULE_8_jquery__('#email').val();
                        var phone = __WEBPACK_IMPORTED_MODULE_8_jquery__('#phone').val();
                        _this.aspirant = {
                            matricno: matricno,
                            firstname: firstname,
                            lastname: lastname,
    ...
    RegisterComponent.prototype.onPaySubmit = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_8_jquery__('body').prepend(pageDimmer);
        this.aspirant.email = __WEBPACK_IMPORTED_MODULE_8_jquery__('#email').val();
        this.aspirant.phone = __WEBPACK_IMPORTED_MODULE_8_jquery__('#phone').val();
        // Required Fields
...
var StatusComponent = (function () {
    ...
    StatusComponent.prototype.ngOnInit = function () {
        var script = document.createElement('script');
        script.innerText = "$('select.dropdown').dropdown();";
        __WEBPACK_IMPORTED_MODULE_7_jquery__('body').append(script);
    ...
    StatusComponent.prototype.populateAspirantForm = function () {
        ...
        this.studentService.getStudentRecord(matricno).subscribe(function (response) {
            if (response.student_info === 'Record not Found!') {
                ...
                var lastname = _this.aspirant_model.lastname = nameArray[0];
                var firstname = _this.aspirant_model.firstname = nameArray[1];
                _this.aspirant_model.middlename = middlename;
                var email = response.student_info.email;
                var department = 'COMPUTER & MATHEMATICS';
                var course = 'COMP/MATH';
                _this.aspirant_model.office = _this.aspirant.office;
...
var VoteComponent = (function () {
    ...
    VoteComponent.prototype.voterSlip = function (matricno) {
        var _this = this;
        this.voteService.fetchVoterReceipt(matricno).subscribe(function (response) {
            if (response.success) {
                _this.voteReceipt = response.voteSlip;
                __WEBPACK_IMPORTED_MODULE_9_jquery__('#pageDimmer').remove();
            }
            else {
                _this.toasterService.pop('info', 'Sorry!', 'We could not find your receipt.');
                __WEBPACK_IMPORTED_MODULE_9_jquery__('#pageDimmer').remove();
            }
        }, function (error) {
            _this.toasterService.pop('error', 'Oops!', 'We just encountered a server error fetching your receipt.');
            __WEBPACK_IMPORTED_MODULE_9_jquery__('#pageDimmer').remove();
        });
    };
...
var AspirantService = (function () {
    ...
    AspirantService.prototype.getAspirants = function () {
        ...
        return this.http.get(this.apiService.getAPI() + 'aspirants', {
            headers: headers
        }).map(function (res) { return res.json(); }).catch(function (err) { return err.toString(); });
    };
    ...
    AspirantService.prototype.deleteAspirant = function (matricno) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        this.authService.loadToken();
        headers.append('Authorization', this.authService.authToken);
        headers.append('Content-Type', 'application/json');
...
var VoteService = (function () {
    ...
    VoteService.prototype.getVoteStatus = function (matricno) {
        ...
        headers.append('Authorization', this.authService.authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.apiService.getAPI() + 'vote/status/' + matricno, {
            headers: headers
        }).map(function (res) { return res.json(); }).catch(function (err) { return err.toString(); });
    };
    VoteService.prototype.saveVote = function (voteSlip) {
        ...
        headers.append('Authorization', this.authService.authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.post(this.apiService.getAPI() + 'vote', voteSlip, {
            headers: headers
        }).map(function (res) { return res.json(); }).catch(function (err) { return err.toString(); });
    };
    VoteService.prototype.fetchVoterReceipt = function (matricno) {
        var headers = new __WEBPACK_IMPORTED_MODULE_1__angular_http__["Headers"]();
        this.authService.loadToken();
        headers.append('Authorization', this.authService.authToken);
        headers.append('Content-Type', 'application/json');
        return this.http.get(this.apiService.getAPI() + 'vote/receipt/' + matricno, {
            headers: headers
        }).map(function (res) { return res.json(); }).catch(function (err) { return err.toString(); });
    };
    return VoteService;
